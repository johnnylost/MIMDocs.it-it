---
title: Ottenere i certificati utente | Microsoft Docs
description: 
keywords: 
author: msmbaldwin
ms.author: mbaldwin
...
---
# <a name="get-user-certificates"></a>Ottenere certificati utente
Ottiene l'elenco dei certificati associati all'utente specificato (i certificati rimossi sono filtrati).
...
In caso di esito positivo, restituisce un elenco di oggetti serializzati JSON [Microsoft.Clm.Shared.Certificates.X509ClmCertificate](https://msdn.microsoft.com/library/microsoft.clm.shared.certificates.x509clmcertificate(v=vs.100).aspx) con le proprietà seguenti:
...
NotAfter | La data e l’ora dopo le quali un certificato non è più valido.
NotBefore | La data e l’ora in cui un certificato diventa valido.
RichiestaerNome | L'account che ha richiesto il certificato.
SerialNumber | Numero di serie del certificato.
Stato | Lo stato del certificato.
TemplateCommonNome | Il nome comune del modello del certificato per il certificato.
