---
title: Aggiornamento degli account di servizi specifici di MIM per le notifiche e le approvazioni quando è abilitato gMSA | Microsoft Docs
...
ms.locfileid: "49358223"
---
# <a name="update-of-mim-specific-service-account-for-notifications-to-gmsa"></a>Aggiornamento dell'account di servizio specifico di MIM per le notifiche per gMSA
===========================================

Aggiornare la password per gli account archiviati. Di seguito è disponibile uno script di PowerShell, in modo che i clienti non debbano eseguire la modalità di modifica

PowerShell: Aggiornamento dell'account di Office 365:
