...
| **Servizio e portale MIM** | Windows Server | Windows Server 2012<br/>Windows Server 2012 R2 <br/> Windows Server 2016 * |
| | Active Directory per la foresta PAM dell’ambiente bastion | Windows Server 2012 R2 <br/> Windows Server 2016 * |
| | Active Directory per le foreste esistenti degli scenari PAM | Windows Server 2008 <br/> Windows Server 2008 R2 * <br/> Windows Server 2012 * <br/> Windows Server 2012 R2 * <br/> Windows Server 2016 * |
