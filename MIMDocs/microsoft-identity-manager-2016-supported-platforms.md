...
| | Active Directory per provisioning utenti, PCNS e sincronizzazione elenco indirizzi globale (facoltativo)|Windows Server 2008 R2 SP1<br/>Windows Server 2012<br/>Windows Server 2012 R2 <br/> Windows Server 2016 * |
...
| **Servizio e portale MIM** | Windows Server | Windows Server 2008 R2 SP1<br/>Windows Server 2012<br/>Windows Server 2012 R2 <br/> Windows Server 2016 * |
| |Scenario PAM: Windows Server | Windows Server 2012 R2 <br/> Windows Server 2016 * |
| |Scenario PAM: Active Directory per la foresta PAM dell'ambiente bastion | Windows Server 2012 R2 <br/> Windows Server 2016 * |
...
| | Browser | Tutti i principali browser * (solo dispositivi mobili)|
| **Servizio MIM Reporting** | Windows Server |  Windows Server 2008 R2 SP1<br/>Windows Server 2012 <br/>Windows Server 2012 R2 <br/> Windows Server 2016 * |
