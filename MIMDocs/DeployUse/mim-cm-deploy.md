...
Nella scheda **Gestione richiesta** abilitare **Rendi la chiave privata esportabile** e quindi fare clic su **CSP o sulla scheda Crittografia**.
...
- Definire le autorizzazioni nel contenitore ID oggetto
