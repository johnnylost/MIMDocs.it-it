...
Se non è stato configurato il pacchetto di installazione MIM nell'ultimo passaggio, seguire questa procedura per installare i componenti di Microsoft Identity Manager 2016:
...
3.  Leggere il contratto di licenza con l'utente finale e, se si accettano le condizioni di licenza, fare clic su **Avanti**.
...
6.  Nella pagina **Configura la connessione di database MIM** specificare **Crea un nuovo database**.
...
![Immagine relativa all'installazione del servizio e del portale MIM](media/MIM-Install16.png)
