...
| **Funzione foresta bastion** | **Priorità relativa durante il ripristino** | **Correzione se la funzione non è disponibile** |
| --------------------------- | --------------------- | -------------- |
| Creazione del trust         | Bassa | Attendere fino al ripristino dell'ambiente bastion |
| Migrazione di utenti e gruppi   | Bassa | Attendere fino al ripristino dell'ambiente bastion |
...
| Monitoraggio di utenti e gruppi nella foresta esistente | Bassa | Attendere fino al ripristino dell'ambiente bastion |
...
## Preparazione della distribuzione e procedure di ripristino
